...
#ssh aliases
alias srv_odoo='ssh -i ~/Documents/sshkeys/stg_hq ubuntu@$IP_ODOO_SRV'
alias rbh_srv_odoo='ssh -i ~/.ssh/odoo_srv_raouf_key raouf@$IP_ODOO_SRV'
alias ec2_sf_utils='ssh -i ~/Documents/sshkeys/ec2_sf_utils ubuntu@$IP_SF_UTILS'
alias ec2_sf_utils_raouf='ssh -i ~/Documents/sshkeys/ec2_sf_utils raouf@$IP_SF_UTILS'
